...
class ChatbotAssistant:
    ...
    def Load_model(self,model_path,dimension_path):
        ...
        self.model = ChatbotModel(input_size=dimension['input_size'],output_size=dimension['output_size'])
    ...
    def process_message(self,input_message):
        ...
        pred_index = torch.argmax(predictions,dim=1).item()
        predicted_intent = self.intents[pred_index]
...
def get_stock():
    ...
    return f'{random.sample(stocks,3)}'
